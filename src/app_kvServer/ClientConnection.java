                        ...
                        case PUT:
                            ...
                            try {
                                ...
                                if (writeModifyDeleteStatus) {
                                    ...
                                    kvServer.notifyAllKey(request.getKey(), "wrote key: " + request.getKey() + "->" + request.getValue());
                                    ...
                                    kvServer.notifyAllKey(request.getKey(), "modified key: " + request.getKey() + "->" + request.getValue());
                                    return new ClientServerRequestResponse(request.getId(), request.getKey(), request
                                            .getValue(),
